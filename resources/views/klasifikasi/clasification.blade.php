...
<main id="main" class="main">
    <div class="pagetitle">
      <h1>Sub Klasifikasi III</h1>

      <div style="margin-bottom: 10px; display: flex; justify-content: flex-end;">
      <a href="{{ route('klasifikasi.create') }}" class="btn btn-primary">Tambah Sub Klasifikasi III</a>
      </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-12 px-3">
          <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
              <h1 class="card-title px-2" style="font-size: 16px">Daftar Sub Klasifikasi III</h1>
                ...
                @foreach ($class as $index => $class)
                  <tr>
                    ...
                    <td class="col-0" style="display: flex; justify-content: flex-end;">
                        ...
                        <a href="{{ route('klasifikasi.edit', $class->id) }}"><span class="badge bg-warning">Update</span></a>

                        <form action="{{ route('klasifikasi.destroy', $class->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('DELETE')
        ...
        <script>
            ...
            $('.view-class').on('click', function() {
                ...
                $.ajax({
                    url: '/klasifikasi/subklasifikasi/' + classId,
                    method: 'GET',
