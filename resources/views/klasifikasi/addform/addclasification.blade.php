...
<main id="main" class="main">
    <div class="pagetitle">
      <h1 class="mb-2">Tambah Sub Klasifikasi III</h1>
      <nav class="mb-4">
        <ol class="breadcrumb">
      ...
      <div class="card">
        <div class="card-body">
            <h4 class="card-title ml-4 mb-6">Formulir Tambah Sub Klasifikasi III</h4>

          <!-- Horizontal Form -->
          <form action="{{ route('klasifikasi.store') }}" method="POST" class="px-3">
            @csrf
            <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-2 col-form-label">Sub Klasifikasi III</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="subkelas" name="subkelas" placeholder="Masukan judul sub klasifikasi III" required value="{{ old('subkelas') }}">
              </div>
            </div>
            <div class="row mb-3">
