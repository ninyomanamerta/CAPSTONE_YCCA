    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb text-bold mt-1">
          <li class="breadcrumb-item active"><a href=""style="color: #1c1b1a; font-weight: bold; font-size:15px;"><b>Jenis</a></li>
          <li class="breadcrumb-item active"><a href="">Mapel</b></a></li>
